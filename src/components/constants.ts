...
export const NODE_IMAGE_MAP: Record<NodeType, string[]> = {
    ...
    asteroid: [NODE_IMAGES.rocky_planet], // Fallback
};
  ...
  },
  {
    ...
    effect: (gs, imageUrl) => {
      const newStar: GameNode = {
        ...
        maxIntegrity: 10, currentIntegrity: 10, integrityCooldown: 0,
      };
  ...
  // CHAPTER 1: Age of Matter
  {
    ...
    effect: (gs, imageUrl) => {
      ...
      const newPlanet: GameNode = {
        ...
        maxIntegrity: 5, currentIntegrity: 5, integrityCooldown: 0,
      };
